...
export default function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-transparent px-[var(--gutter)] pt-[var(--sp-3)]">
      <div
        ...
        style={{
          boxShadow:
            "0px 2px 6px rgba(179, 199, 255, 0.08), 0px 12px 32px rgba(179, 199, 255, 0.14), 0px 32px 80px rgba(179, 199, 255, 0.18)",
        }}
      >
        <Link
          href={ROUTES.landing}
